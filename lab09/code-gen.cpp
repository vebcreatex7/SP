...
int tCG::p17(){ //  HMUL -> HMUL E
 ...
 ++S1->count;
	return 0;}
int tCG::p18(){ //   SET -> HSET E )
    S1->obj +=  " = " + S2->obj + ";\n";
	return 0;}
int tCG::p19(){ //   HSET -> ( set! $id
 S1->obj = "\t" + decor(S3->name);
	return 0;}
int tCG::p20(){ //   DEF -> PROC
	return 0;}
int tCG::p21(){ //  DEFS -> DEF
	return 0;}
int tCG::p22(){ //  DEFS -> DEFS DEF
 S1->obj += S2->obj;
	return 0;}

int tCG::p23(){ //  PROC -> HPROC E )
 S1->obj += "return " + S2->obj+";\n}\n";
	return 0;}
int tCG::p24(){ // HPROC -> PCPAR )
 S1->obj += ")";
 declarations += S1->obj + ";\n"; //!!!
 S1->obj += "{\n";
	return 0;}
int tCG::p25(){ // HPROC -> HPROC SET
 S1->obj += S2->obj + "\n";
	return 0;}
int tCG::p26(){ // PCPAR -> ( define ( $id
 S1->obj = "double " + decor(S4->name) + "(";
 S1->count = 0;
 S1->name = S4->name;
	return 0;}
int tCG::p27(){ // PCPAR -> PCPAR $id
